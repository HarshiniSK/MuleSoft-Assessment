...
cursor.execute('''INSERT INTO movies(id, Movie_Name, Lead_Actor, Lead_Actress, Director_Name,Year_Of_Release) VALUES(1,"Don","Sivakarthikeyan Doss","Priyanka ArulMohan","Cibi Chakravathi",2022)''')
...
cursor.execute('''INSERT INTO movies(id, Movie_Name, Lead_Actor, Lead_Actress, Director_Name,Year_Of_Release) VALUES(3,"Doctor","Sivakarthikeyan Doss","Priyanka ArulMohan","Nelson",2021)''')
